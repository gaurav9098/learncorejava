...
public class CloningTest {
	...
	public static void main(String[] args) throws CloneNotSupportedException {
		...
		// change emp name // String value didnt change as String is immutable
		emp.setName("new");
		System.out.println("clonedEmp name:" + clonedEmp.getName());

		
		// ANother way of cloning using serialization
		
		
		//another way of cloning using apache commons util class
